...
/* (IY)
 * Command host to request and recieve file from another host.
 * User inputs:
 *	- name of file to transfer;
 *	- id of host to ping;
 *
 * A command message is setn to the current host.
 *	The message starts with a 'd' followed by the:
 *		- id of host to request file
